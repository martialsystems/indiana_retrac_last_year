...
Two answers. Last year wins the assignment. Last year loses the county total. Locked `5800fc3`. That is the product. Do not average it. On the 4370 origin-facility-quarter cells where last year exists, last-year RMSE is 6504.7 tons against mileage-plus-population 16633.0. MAE is 1144.0 against 4455.3. Cell-level is the logistics question. Origin-quarter RMSE 23313.3 against 0.0 is not a counter-finding: the bar is scaled to the observed county total, so its origin error is zero by construction. Last year is a lag-4 copy of last year’s total. Marion last-year RMSE 10534 against 45659, Lake 10981 against 49904: last year still picks the plants better than miles; it does not know this year’s tonnage. Origin population cancels inside each county’s shares. Confirmation 2025 last-year RMSE 8059.0 against 16227.2 does not reopen the page. Fixture skill does not rescue live.

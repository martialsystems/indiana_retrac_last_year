...
"""Live IDEM quarterly XLSX vs last year and inverse-miles. Empty cores stop."""
...
from retrac.errors import FetchError  # noqa: E402
from retrac.pipeline import run_live  # noqa: E402
...
def main() -> int:
    ...
    print("origin-total last-year RMSE", hold["origin_total"]["last_year_rmse"], "bar", hold["origin_total"]["bar_rmse"])
